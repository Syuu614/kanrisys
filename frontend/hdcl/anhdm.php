...
<?php }?>
  ...
  <tbody>
      <tr>
      <td>请输入活动名称：<input type="text" name="ac_name" maxlength="10" placeholder="活动名称" class="form-control"/></td>
    </tr>
    <tr>
...
//------------------------------------------------------------------------------------------
  ...
  $sql="select ac_name,ac_per,ac_tani,ac_class,ac_budget,ac_info,ac_tip,ac_approve,ac_apper from activity where ac_name='$ac_name'";
