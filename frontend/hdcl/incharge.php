...
//------------------------------------------------------------------------------------------
  ...
  $myrow=mysqli_fetch_array($result);
  $name=$myrow[0];
  $sql="select ac_name,ac_per,ac_tani,ac_class,ac_budget,ac_info,ac_tip,ac_approve,ac_apper from activity where ac_per='$name'";
...
?>
    ...
    <?php } ?>
    <tr>
      <td><a href="hdcx.php" class="btn btn-link">返回</a></td>
    </tr>
  </tbody>
</table>
		</div>
...
<div style="margin-bottom:61px">
		...
		<div class="col-md-4 column" id="panel"></div>
<!-- 详细资料 -->
