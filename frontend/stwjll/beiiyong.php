...
<?php }?>
  ...
  <tbody>
      <tr>
      <td><a href="stzc.php" class="btn btn-link">社团章程</a></td>
    </tr>
    <tr>
      <td><a href="gzzd.php" class="btn btn-link">规章制度</a></td>
    </tr>
    <tr>
      <td><a href="kjjtz.php" class="btn btn-link">科技节通知</a></td>
    </tr>
  </tbody>
</table>
<div style="margin-bottom:61px">
		...
		<iframe src="/files/2019管理学院科协章程.pdf" width="100%" height="250%" style="border-radius:10px;border-style:none"></iframe>
		</div>
	</div>
</div>
</body>
