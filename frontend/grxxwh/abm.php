...
<?php }?>
  ...
  <tbody>
      <tr>
      <td>请输入部门名称：<input type="text" name="depart" maxlength="10" placeholder="输入部门名称" class="form-control"/></td>
    </tr>
    <tr>
...
<a href="cxtrxx.php" class="btn btn-link">返回</a>
</div>
		</div>
...
//------------------------------------------------------------------------------------------
  ...
  $sql="select name,sex,place,depart,major,phone,mail from user where depart='$depart'";
