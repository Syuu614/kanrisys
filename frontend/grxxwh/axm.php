...
<?php }?>
  ...
  <tbody>
      <tr>
      <td>请输入一个姓名：<input type="text" name="name" maxlength="10" placeholder="ta的名字" class="form-control"/></td>
    </tr>
    <tr>
...
//------------------------------------------------------------------------------------------
  ...
  $sql="select name,sex,place,depart,major,phone,mail from user where name='$name'";
