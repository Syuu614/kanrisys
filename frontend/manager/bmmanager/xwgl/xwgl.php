  ...
  <tbody>
      ...
      <td>
        <form class="form-inline" method="post" action="">
          <input type="text" name="ss" placeholder="查询新闻" class="form-control"/>
          <button type="submit" class="btn btn-default" style=""><i class="fa fa-search" aria-hidden="true"></i></button>
        </form>
      </td>
    </tr>
      <tr>
      <td><a href="insert.php" class="btn btn-link">增加新闻</a></td>
    </tr>
    <tr>
      <td><a href="/frontend/manager/bmmanagermain.php" class="btn btn-link">返回</a></td>
    </tr>
  </tbody>
</table>
...
//------------------------------------------------------------------------------------------
  ...
  if (isset($ss)||$ss!=null||$ss!="") {
      $sql="select ID,ne_title,ne_content from news where ne_title like('%$ss%') or ne_content like('%$ss%') or ne_author like('%$ss%') or ne_belong like('%$ss%') or ne_time like('%$ss%') ";
  }else{
      $sql="select ID,ne_title,ne_content from news";
  }
