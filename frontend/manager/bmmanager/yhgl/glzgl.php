...
<div class="container">
	...
	<div class="row clearfix">
		...
		<h1>部门管理者管理</h1>
		<hr/>
		<div style="margin-bottom:5px"><a href="cygl.php" class="btn btn-link">成员管理</a><a href="yhgl.php" class="btn btn-link">返回上一级</a><a href="/frontend/manager/bmmanagermain.php" class="btn btn-link">返回后台主界面</a></div>
        ...
        <a href="/frontend/manager/bmmanager/yhgl/cygl.php" class="btn btn-link" style="">还原</a>
        </form>   
		</div>
	</div>
...
//------------------------------------------------------------------------------------------
  ...
  if (isset($ss)||$ss!=null||$ss!="") {
      $sql="select ID,name,sex,place,depart,major,phone,mail from user where name like('%$ss%') or sex like('%$ss%') or place like('%$ss%') or depart like('%$ss%') or major like('%$ss%') or phone like('%$ss%') or mail like('%$ss%') and auth='1' and depart='$depart'";
  }else{
      $sql="select ID,name,sex,place,depart,major,phone,mail from user where depart='$depart' and auth='1'";
  }
