...
<div class="container">
	...
	<div class="row clearfix">
		...
		<h1>部门成员管理</h1>
		<hr/>
		<div style="margin-bottom:5px"><a href="glzgl.php" class="btn btn-link">管理者管理</a><a href="sjgl/insert.php" class="btn btn-link">增加新成员</a><a href="yhgl.php" class="btn btn-link">返回上一级</a><a href="/frontend/manager/bmmanagermain.php" class="btn btn-link">返回后台主界面</a></div>
...
//------------------------------------------------------------------------------------------
  ...
  if (isset($ss)||$ss!=null||$ss!="") {
      $sql="select ID,name,sex,place,depart,major,phone,mail from user where name like('%$ss%') or sex like('%$ss%') or place like('%$ss%') or major like('%$ss%') or phone like('%$ss%') or mail like('%$ss%') and depart='$depart'";
  }else{
      $sql="select ID,name,sex,place,depart,major,phone,mail from user where depart='$depart'";
  }
