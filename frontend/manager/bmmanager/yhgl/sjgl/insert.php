...
<div class="container">
	...
	<div class="row clearfix">
		...
		<form method="post" action="/backend/manage/bk_bzinsert.php">
  ...
  ?>
    ...
    <tr>
      <td>部门：<input type="text" name="depart" maxlength="10" placeholder="部门" class="form-control" value="<?php echo $depart; ?>" disabled /></td>
    </tr>
