...
$depart=$myrow[0];
  ...
  if (isset($ss)||$ss!=null||$ss!="") {
      $sql="select * from signup where si_name like('%$ss%') or si_sex like('%$ss%') or si_major like('%$ss%') or si_phone like('%$ss%') or si_mail like('%$ss%') or si_depart like('%$ss%') or si_adjust like('%$ss%') or si_intro like('%$ss%') or si_check like('%$ss%') and si_depart='$depart'";
  }else{
      $sql="select * from signup where si_depart='$depart'";
  }
...
?>
      ...
      <td>
        ...
        <button class="btn btn-link" type="submit">审核</button></form>
      </td>
      <td>
