...
<div class="container">
	...
	<div class="row clearfix">
		...
		<h1>管理者管理</h1>
		<hr/>
		<div style="margin-bottom:5px"><a href="/frontend/manager/gjmanager/yhgl/cygl.php" class="btn btn-link">成员管理</a><a href="insert.php" class="btn btn-link">增加新管理者</a><a href="/frontend/manager/gjmanager/yhgl/glzgl.php" class="btn btn-link">返回上一级</a><a href="/frontend/manager/gjmanagermain.php" class="btn btn-link">返回后台主界面</a></div> 
		</div>
	</div>
