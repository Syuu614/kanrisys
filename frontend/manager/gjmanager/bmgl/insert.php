...
<div class="container">
	...
	<div class="row clearfix">
		...
		<form method="post" action="/backend/bmmanage/bk_insert.php"><!--  -->
  ...
  <tbody>
      <tr>
      <td>部门名称：<input type="text" name="name" placeholder="部门名称" class="form-control"/></td>
    </tr>
        <tr>
      <td>部门简介：<input type="text" name="info" placeholder="部门简介" class="form-control"/></td>
    </tr>
    <tr>
...
<a href="/frontend/manager/gjmanager/bmgl/bmgl.php" class="btn btn-link">返回</a>
</div>
		</div>
