...
<?php }?>
	...
	<div class="row clearfix">
		...
		<form method="post" action="/backend/bk_dlzhsz.php">
  ...
  <tbody>
      <tr>
      <td>旧用户名：<input type="text" name="yhm" maxlength="10" placeholder="姓名" class="form-control"/></td>
      </tr>
      <tr>
      <td>旧密码：<input type="password" name="mm" maxlength="20" placeholder="旧密码" class="form-control"/></td>
      </tr>
      <tr>
